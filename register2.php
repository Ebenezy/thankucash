                    ...
                    <div class="form-items">
                        ...
                        <?php
                          ...
                          if(isset($_POST['submit'])) {
                            ...
                            if($business_name == "" || $username == "" || $business_address == "" || $full_name == "" || $password == "" || $phone == "" || $email == "") {
                              echo "All fields should be filled. Either one or many fields are empty.";
                              echo "<br/>";
                              echo "<a href='register.php'>Go Back</a>";
                            } else {
                              mysqli_query($mysqli, "INSERT INTO login(business_name, username, business_address, full_name, email, phone, password) VALUES('$business_name', '$username', '$business_address', '$full_name', '$email', '$phone', md5('$password'))")
                        ...
                        <form name="form1" method="post" action="">
                            <div class="email_phone">
                              <input class="form-control input_2" type="text" name="business_name" placeholder="Name of Business" required>
                              <input class="form-control " type="text" name="username" placeholder="Username" required>
                            </div>

                            <input class="form-control" type="text" name="business_address" placeholder="Address of Business" required>
                            <div class="email_phone">
                                <input class="form-control input_2" type="text" name="full_name" placeholder="Contact Person Name" required>
                                <input class="form-control" type="email" name="email" placeholder="Contact Person Email" required>
                            </div>
                            <div class="email_phone">
                                <input class="form-control input_2" type="number" name="phone" placeholder="Contact Person Number" required>
