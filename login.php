                    ...
                    <div class="form-items">
                        ...
                        <form name="form1" method="post" action="">
                            ...
                            <div class="form-button">
                                <button id="submit" type="submit" name="submit" class="ibtn">Login</button> <a href="forget.html">Forget password?</a>
                            </div>
                        </form>
                        <?php
                        }
...
<!-- <script>
        window.location = "https://app.thankucash.com";
    </script>
